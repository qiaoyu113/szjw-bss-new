        ...
        <template slot-scope="{node, data}">
          ...
          <div class="right-btn">
            <el-button
              ...
              v-permission="['/v1/base/authority/create/6']"
              circle
              size="mini"
            ...
            <el-button
              ...
              v-permission="['/v1/base/authority/deleteByAuthId/6']"
              circle
              size="mini"
              class="delete"
            ...
            <el-button
              v-if="node.level !== 1 && node.level !== 2"
              v-permission="['/v1/base/authority/update/6']"
              circle
              size="mini"
              icon="el-icon-edit"
...
export default class extends Vue {
  ...
  private async authorityList() {
    this.loading = true
    const { data } = await authorityListNew({ sysType: 6 })
    this.loading = false
    if (data.success) {
      this.data = data.data
    } else {
