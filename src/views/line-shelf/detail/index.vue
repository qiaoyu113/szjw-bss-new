<template>
  <div class="p15 Detail">
    ...
    >
      ...
      >
        <template v-slot:operationBefore="scope">
          <span>{{ scope.row.operationBefore }}</span>
        </template>
        <template v-slot:operationAfter="scope">
          <span>{{ scope.row.operationAfter }}</span>
        </template>
      </self-table>
    </sectioncontainer>
  </div>
