export default {
  route: {
    ...
    driverClue: 'DriverClue',
    createDriverClue: 'createDriverClue',
    editDriverClue: 'editDriverClue',
    driverInterview: 'driverInterview',
    driverFollowClue: 'driverFollowClue',
    ...
    dealManageDetail: 'DealManageDetail',
    dealForm: 'DealForm',
    dealStatistics: 'DealStatistics',
    deliveryTitle: 'DeliveryManage',
    dealManage: 'dealManage',
    buyCar: 'BuyCarDelivery',
    GPS: 'GPSDelivery',
    carType: 'BuyCarType',
    rentCar: 'RentCarType',
    gpsManage: 'GPSManage',
